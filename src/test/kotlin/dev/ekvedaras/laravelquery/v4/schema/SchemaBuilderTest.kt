...
internal class SchemaBuilderTest : BaseTestCase() {
    ...
    fun testCompletesSchemas() {
        myFixture.configureByFile("v4/schema/createDatabase.php")
        myFixture.completeBasic()
    ...
    fun testDoesNotWarnAboutUnknownSchema() {
        assertInspection("v4/schema/unknownSchema.php", UnknownTableOrViewInspection())
    }

    fun testDoesNotWarnAboutUnknownTable() {
        assertInspection("v4/schema/unknownTable.php", UnknownTableOrViewInspection())
    }

    fun testResolvesSchemaReference() {
        myFixture.configureByFile("v4/schema/knownSchema.php")
    ...
    fun testResolvesTableReference() {
        myFixture.configureByFile("v4/schema/knownTable.php")
