...
data class WhereQueryVariable(override val variable: Variable) : QueryVariable, InterestedInUpperScope {
    init {
        ...
        if (!variable.isInsideCallOfMethod("where")) throw Exception("Variable ${variable.name} is not inside where method");
