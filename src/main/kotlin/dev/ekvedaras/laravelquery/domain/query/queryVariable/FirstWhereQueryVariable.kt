...
data class FirstWhereQueryVariable(override val variable: Variable) : QueryVariable, InterestedInUpperScope {
    init {
        ...
        if (!variable.isInsideCallOfMethod("firstWhere")) throw Exception("Variable ${variable.name} is not inside where method");
