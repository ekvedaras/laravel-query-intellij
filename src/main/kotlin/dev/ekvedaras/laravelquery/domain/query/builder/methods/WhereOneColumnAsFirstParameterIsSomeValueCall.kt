...
class WhereOneColumnAsFirstParameterIsSomeValueCall(override val reference: MethodReference, override val queryStatement: QueryStatement) : QueryMethodCall, ColumnSelectionCall {
