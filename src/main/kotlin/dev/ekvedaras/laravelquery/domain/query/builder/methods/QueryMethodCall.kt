    ...
    companion object {
        fun from(reference: MethodReference, queryStatement: QueryStatement): QueryMethodCall? {
            ...
            return when (reference.name) {
                "query", "getQuery", "newQuery", "newModelQuery", "newQueryWithoutRelationships", "toBase",
                ...
                "increment", "decrement", "qualifyColumn", "incrementOrDecrement" -> WhereOneColumnAsFirstParameterIsSomeValueCall(reference, queryStatement)
                ...
                "hasMany", "hasOne", "belongsTo" -> HasManyCall(reference, queryStatement)
                else -> {
